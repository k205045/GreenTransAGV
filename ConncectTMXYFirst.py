                                ...
                                if len(a) > 3:
                                    if a[2] == '90':
                                        ...
                                        if M1:
                                            ...
                                            x = Decimal(M1[0]-tmp_x) * Decimal(cos(angle*Decimal(pi)/180)) + Decimal(M1[1]-tmp_y) * \
                                                Decimal(sin(angle*Decimal(pi)/180)) - Decimal(c[0])
                                            y = Decimal(M1[1]-tmp_y) * Decimal(cos(angle*Decimal(pi)/180)) - Decimal(M1[0]-tmp_x) * \
                                                Decimal(sin(angle*Decimal(pi)/180)) - Decimal(c[1])
